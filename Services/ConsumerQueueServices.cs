...
{
    public class ConsumerQueueServices : IConsumerQueueServices
    {
        public QueueClient _queueClient;
   
        public ConsumerQueueServices()
        {
       
            _queueClient = new QueueClient("DefaultEndpointsProtocol=https;AccountName=azattekcetest;AccountKey=H4LnBl+QUD+b4yQigTIoF549tTD6pQ5TJ/nPOM063zJCJGjCz1XQT82LHkQ/UV1Ungpm+/w4MNw8+AStvfLcBg==;EndpointSuffix=core.windows.net","myconsumer");
